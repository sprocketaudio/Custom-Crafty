        ...
        clickDate: function(e) {
            ...
            if (this.endDate || date.isBefore(this.startDate, 'day')) { //picking start
                if (this.timePicker) {
                    ...
                    if (isNaN(minute)) {
                        var leftMinOpts = this.container.querySelector('.left .minuteselect').options;
                        minute = parseInt(leftMinOpts[leftMinOpts.length - 1].value, 10);
                    }
                ...
                if (this.timePicker) {
                    ...
                    if (isNaN(minute)) {
                        var rightMinOpts = this.container.querySelector('.right .minuteselect').options;
                        minute = parseInt(rightMinOpts[rightMinOpts.length - 1].value, 10);
                    }
